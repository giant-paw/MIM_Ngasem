...
<head>
    ...
    <title>Ekstrakurikuler Drumband - MI Ngasem Selatan</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Highlights Section (for instruments/roles) */
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h1 class="section-title">Ekstrakurikuler Drumband</h1>
                <div class="divider"></div>
                <p>Membangun Harmoni, Disiplin, dan Semangat Juara Melalui Dentuman Irama yang Menggema.</p>
            </div>
        </section>
            ...
            <div class="container">
                <div class="intro-grid">
                    ...
                    <div class="intro-content">
                        ...
                        <p>Ekstrakurikuler Drumband adalah pilihan tepat bagi siswa yang energik, menyukai musik, dan ingin belajar tentang kerjasama tim. Di sini, siswa tidak hanya belajar memainkan alat musik, tetapi juga dilatih untuk memiliki disiplin tinggi, kekompakan, dan rasa tanggung jawab.</p>
                        <p>Setiap anggota adalah bagian penting dari sebuah harmoni besar. Kami melatih siswa untuk menjadi musisi yang handal sekaligus individu yang tangguh dan mampu memimpin.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="highlights-section">
            <div class="container">
                <h2 class="section-title" style="text-align: center;">Bagian & Peran dalam Tim</h2>
                <div class="divider"></div>
                <div class="highlights-grid">
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-drum"></i></div>
                        <h3>Pasukan Perkusi</h3>
                        <p>Bagian inti yang menjaga tempo dan irama, terdiri dari snare drum, bass drum, tenor, dan simbal.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-music"></i></div>
                        <h3>Pasukan Melodi</h3>
                        <p>Pemain pianika dan bellyra yang menciptakan alunan melodi indah sebagai pemanis harmoni musik.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-flag"></i></div>
                        <h3>Color Guard</h3>
                        <p>Barisan pembawa bendera yang mempercantik penampilan dengan koreografi visual yang memukau.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-star"></i></div>
                        <h3>Gitapati & Mayoret</h3>
                        <p>Pemimpin barisan yang bertugas memberi komando, memimpin lagu, dan menjadi pusat perhatian.</p>
                    </div>
                </div>
            </div>
        </section>
