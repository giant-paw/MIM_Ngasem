...
<head>
    ...
    <title>Program Tahfidz - MI Ngasem Selatan</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .program-intro-section { padding: 4rem 0; background-color: #f9f9f9; }
        ...
        .intro-content strong { color: var(--primary-color); font-weight: 600; }
        ...
        .cta-section { padding: 4rem 0; background-color: var(--primary-color); color: var(--light-color); text-align: center; }
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h1 class="section-title">Program Tahfidz Qur'an</h1>
                <div class="divider"></div>
                <p>Membentuk Generasi Qur'ani yang Cerdas dan Berakhlak Mulia, Menghafal Al-Qur'an dengan Metode yang Mudah dan Menyenangkan.</p>
            </div>
        </section>

        <section class="program-intro-section">
            <div class="container">
                <div class="intro-grid">
                    ...
                    <div class="intro-content">
                        ...
                        <p>Program Tahfidz di MI Muhammadiyah Ngasem Selatan dirancang khusus untuk membantu siswa-siswi kami dalam menghafal Al-Qur'an secara sistematis dan terstruktur. Kami percaya bahwa interaksi dini dengan Al-Qur'an tidak hanya mempertajam daya ingat, tetapi juga membentuk karakter Islami yang kuat.</p>
                        <p>Dengan bimbingan guru-guru yang kompeten dan berpengalaman, kami menciptakan lingkungan belajar yang <strong>mendukung, positif, dan penuh motivasi</strong> agar setiap anak dapat mencapai potensi hafalan terbaiknya.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="highlights-section">
            <div class="container">
                <h2 class="section-title" style="text-align: center;">Keunggulan Program Kami</h2>
                <div class="divider"></div>
                <div class="highlights-grid">
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-book-open"></i></div>
                        <h3>Metode Inovatif</h3>
                        <p>Menggunakan metode hafalan yang mudah diikuti dan menyenangkan, disesuaikan dengan perkembangan usia anak.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-user-friends"></i></div>
                        <h3>Pembimbing Ahli</h3>
                        <p>Dibimbing langsung oleh para hafidz/hafidzah yang sabar dan berpengalaman dalam mengajar anak-anak.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-check-circle"></i></div>
                        <h3>Evaluasi Berkala</h3>
                        <p>Sistem evaluasi dan setoran hafalan (muraja'ah) yang rutin untuk menjaga kualitas dan kelancaran hafalan.</p>
                    </div>
                </div>
            </div>
        </section>
