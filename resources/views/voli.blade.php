...
<head>
    ...
    <title>Ekstrakurikuler Bola Voli - MI Ngasem Selatan</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Highlights Section (for skills/training) */
...
<body>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                <h1 class="section-title">Ekstrakurikuler Bola Voli</h1>
                <div class="divider"></div>
                <p>Kembangkan Potensi, Raih Prestasi, dan Bangun Sportivitas di Atas Lapangan.</p>
            </div>
        </section>
            ...
            <div class="container">
                <div class="intro-grid">
                    <div class="intro-content">
                        <h2>Lebih dari Sekadar Olahraga</h2>
                        <p>Ekstrakurikuler Bola Voli adalah sarana yang tepat untuk menyalurkan minat dan bakat siswa di bidang olahraga, khususnya bola voli. Program ini berfokus pada pengembangan kemampuan fisik, penguasaan teknik, dan pemahaman strategi permainan.</p>
        ...
        <section class="highlights-section">
            <div class="container">
                <h2 class="section-title" style="text-align: center;">Fokus Latihan Kami</h2>
                <div class="divider"></div>
                <div class="highlights-grid">
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-volleyball-ball"></i></div>
                        <h3>Teknik Dasar</h3>
                        <p>Menguasai fundamental permainan seperti servis, passing, set, spike, dan block secara benar dan efektif.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-users"></i></div>
                        <h3>Kerja Sama Tim</h3>
                        <p>Membangun kekompakan dan strategi bermain melalui latihan formasi, rotasi, dan komunikasi di lapangan.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-running"></i></div>
                        <h3>Stamina & Fisik</h3>
                        <p>Meningkatkan kebugaran, kelincahan, kekuatan lompatan, dan daya tahan tubuh melalui latihan fisik terstruktur.</p>
                    </div>
                    <div class="highlight-card">
                        <div class="icon"><i class="fas fa-handshake"></i></div>
                        <h3>Sportivitas</h3>
                        <p>Menanamkan nilai-nilai kejujuran, saling menghargai, dan sikap pantang menyerah dalam setiap latihan dan pertandingan.</p>
                    </div>
                </div>
            </div>
        </section>
