    ...
    <div class="admin-layout">
        ...
        <div class="content-wrapper">
            <header class="main-header">
                {{-- Judul disesuaikan apakah ini form Tambah atau Edit --}}
                    ...
                    <form action="{{ isset($guru) ? route('admin.guru.update', $guru->id) : route('admin.guru.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @if(isset($guru) && $guru->foto)
                                <small style="display: block; margin-top: 10px;">Foto saat ini: <a href="{{ asset('storage/' . str_replace('public/', '', $guru->foto)) }}" target="_blank">Lihat foto</a></small>
                            @endif
                            @error('foto')
