                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($guru->foto)
                                            <img src="{{ asset('storage/' . str_replace('public/', '', $guru->foto)) }}" alt="Foto {{ $guru->nama_lengkap }}" class="teacher-photo">
                                        @else
                                    ...
                                    <td>{{ $guru->jabatan }}</td>
                                    <td>
                                        <a href="{{ route('admin.guru.edit', $guru->id) }}" class="btn btn-action btn-edit">Edit</a>
