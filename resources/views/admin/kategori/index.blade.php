    ...
    <div class="admin-layout">
        ...
        <main class="main-content">
            ...
            <div class="table-container">
                <a href="{{ route('admin.kategori.create') }}" class="btn-add">Tambah Kategori Baru</a>
                            ...
                            <tr>
                                ...
                                <td class="action-buttons">
                                    ...
                                    <form action="{{ route('admin.kategori.destroy', $item->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus kategori ini?')">Hapus</button>
                                    </form>
                                </td>
                            </tr>
                        @empty
