...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .current-image-preview img { max-width: 200px; border-radius: 8px; border: 1px solid var(--border-color); }


        /* --- TRIX EDITOR STYLING --- */
        trix-editor { border: 1px solid var(--border-color); border-radius: 8px; padding: 1rem; min-height: 300px; background-color: var(--card-bg); }
        trix-editor:focus-within { border-color: var(--primary-color); box-shadow: 0 0 0 3px rgba(79, 70, 229, 0.2); }
        .trix-button-group { border-bottom: 1px solid var(--border-color) !important; margin-bottom: 10px !important; padding-bottom: 10px !important; }
                            ...
                            <input type="file" id="gambar_utama" name="gambar_utama" class="form-control form-control-file">
                             @if($berita->gambar_utama)
                                <div class="current-image-preview">
                                    <p>Gambar saat ini:</p>
                                    <img src="{{ Storage::url($berita->gambar_utama) }}" alt="Gambar saat ini">
                                </div>
                            @endif
                        </div>
